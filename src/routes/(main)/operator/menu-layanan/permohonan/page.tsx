  ...
  return (
    <section class="container mx-auto px-16">
      ...
      <MenuContainer>
        ...
        <div class="overflow-x-hidden form-control justify-between min-h-96">
          {sortedPermohonan().length > 0 ? (
            <>
              ...
              <div class="join flex items-center justify-center gap-8">
                <button
                  class={`join-item ${
                ...
                <div class="join-item text-sm font-normal">
            ...
            <div class="flex justify-center">Tidak ada Data Permohonan</div>
          )}
        </div>
      </MenuContainer>
    </section>
