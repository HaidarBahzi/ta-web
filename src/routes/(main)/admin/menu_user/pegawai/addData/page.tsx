    ...
    <section class="container mx-auto px-16">
      ...
      <MenuContainer>
        ...
        <form
          ...
          class="form-control gap-8 px-8"
        >
          <div class="grid grid-cols-6 gap-x-12 gap-y-4 items-center">
            <LimitedTextInput
              labelText={"NIK"}
            ...
            <>
              <label class="text-xs font-normal text-gray-900">
                Pegawai Foto
              </label>
              <div class="indicator">
                <input
                ...
                <button
                  ...
                  class="indicator-item badge bg-blue-500 h-7 w-7 border-none text-white"
                >
                  <i>
                    <RiPencilFill />
                  </i>
                ...
                <button
                  ...
                  class={`indicator-bottom indicator-item badge bg-red-500 border-none h-7 w-7 text-white ${
                ...
                {selectedImage ? (
                  <Image
                    ...
                    alt="Selected Image"
                    class="w-40 h-40 shadow-lg"
                  />
                ) : (
                  <div class="w-40 h-40 shadow-lg bg-gray-100 text-gray-600 flex justify-center items-center flex-col">
                    <i class="text-2xl">
                      <IoImageOutline />
                    </i>
                    No Image
